...
* [12/15] We release a [new subset](https://huggingface.co/datasets/HaoyeZhang/RLHF-V-Hall_v0/blob/main/RLHF-V-Hall_v0_LLaVA_dpo_with_rlhf-v-sft_logp_train-1065.tsv) in our huggingface dataset! It contains an amount of **1,067 fine-grained human preference data** annotated on the outputs of **LLaVA-13B**. 
